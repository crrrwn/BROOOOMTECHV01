        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
              <router-link
                ...
                class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:border-green-300 hover:bg-green-50 transition-colors duration-200"
              >
          ...
          <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between mb-4">
              ...
              <router-link to="/dashboard/user/my-orders" class="text-green-600 hover:text-green-700 text-sm font-medium">
                View All
              </router-link>
            </div>
            <div class="space-y-4">
              <div v-if="recentOrders.length === 0" class="text-center py-8">
                ...
                <router-link to="/dashboard/user/book-service" class="text-green-600 hover:text-green-700 text-sm font-medium">
            ...
            <div v-for="order in activeOrders" :key="order.id" class="border border-gray-200 rounded-lg p-4">
              ...
              <div class="mb-4">
                ...
                <div class="w-full bg-gray-200 rounded-full h-2">
                  <div class="bg-green-600 h-2 rounded-full transition-all duration-300" :style="{ width: getProgressPercentage(order.status) + '%' }"></div>
                </div>
              </div>
